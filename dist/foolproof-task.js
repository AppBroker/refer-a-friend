(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("foolproof-task", [], factory);
	else if(typeof exports === 'object')
		exports["foolproof-task"] = factory();
	else
		root["foolproof-task"] = factory();
...
var _controller = __webpack_require__(339);

var _controller2 = _interopRequireDefault(_controller);

var _helpers = __webpack_require__(92);

var _template = __webpack_require__(360);
...
var _fonts = __webpack_require__(364);

var _fonts2 = _interopRequireDefault(_fonts);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var store = new _store2.default('foolproof-task');

var template = new _template2.default();
var view = new _view2.default(template, _fonts2.default);
...
var Controller = function () {
  ...
  _createClass(Controller, [{
    ...
    key: 'addItem',
    value: function addItem(name, surname, email) {
      var _this = this;
    ...
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var submitRes, submissionResult;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return (0, _api2.default)(this.store.getStore());
              ...
              case 5:
                submissionResult = _context.sent;
                return _context.abrupt('return', submissionResult);
    ...
    key: 'editItemSave',
    value: function editItemSave(name, surname, email) {
...
var submitApi = exports.submitApi = function submitApi(store) {
  return _axios2.default.post('/referralsubmit', { data: store });
};

exports.default = submitApi;
...
var Store = function () {
  ...
  function Store(name, callback) {
     ...
     */
    this.setLocalStorage = function (referrals) {
  ...
  _createClass(Store, [{
    ...
    value: function find(query, callback) {
      var referrals = this.getLocalStorage();
      var k = void 0;

      callback(referrals.filter(function (refer) {
        for (k in query) {
          if (query[k] !== refer[k]) {
            return false;
          }
    ...
    value: function remove(query, callback) {
      ...
      var referrals = this.getLocalStorage().filter(function (refer) {
        for (k in query) {
          if (query[k] !== refer[k]) {
            return true;
          }
 ...
 */
var Item = exports.Item = void 0;

/**
 * @typedef {!Array<Item>}
 */
var ItemList = exports.ItemList = void 0;
...
var Empty = {
   ...
   * @typedef {Empty}
   */
};var EmptyItemQuery = exports.EmptyItemQuery = void 0;
 ...
 */
var ItemQuery = exports.ItemQuery = void 0;

/**
 * @typedef {!({id: number, title: string}|{id: number, completed: boolean})}
 */
var ItemUpdate = exports.ItemUpdate = void 0;
...
var _itemId = function _itemId(element) {
  return parseInt(element.parentNode.parentNode.parentNode.dataset.id, 10);
};
var ENTER_KEY = 13;
var ESCAPE_KEY = 27;
...
var View = function () {
   ...
   */
  function View(template, fonts) {
    _classCallCheck(this, View);

    this.template = template;
    this.referralList = (0, _helpers.qs)('.component__referral');
    this.submission = (0, _helpers.qs)('.component--submit');
  ...
  _createClass(View, [{
    ...
    key: 'clearNewReferral',
    value: function clearNewReferral() {
    ...
    key: 'setItemValidated',
    value: function setItemValidated(id, validated) {
    ...
    value: function bindAddItem(handler) {
      this.newReferralName = (0, _helpers.qs)('.new-referral-name');
      this.newReferralSurname = (0, _helpers.qs)('.new-referral-surname');
      this.newReferralEmail = (0, _helpers.qs)('.new-referral-email');

      var firstname = void 0;
      var surname = void 0;
      var email = void 0;
      if (this.newReferralName !== null) {
        (0, _helpers.$on)(this.newReferralName, 'change', function (_ref) {
        ...
        (0, _helpers.$on)(this.newReferralSurname, 'change', function (_ref2) {
        ...
        (0, _helpers.$on)(this.newReferralEmail, 'change', function (_ref3) {
    ...
    value: function bindRemoveItem(handler) {
      (0, _helpers.$delegate)(this.referralList, '.destroy', 'click', function (_ref4) {
    ...
    key: 'bindSubmit',
    value: function bindSubmit(handler) {
      (0, _helpers.$delegate)(this.submission, '.btn-light', 'click', function () {
        handler();
      });
    }
    ...
    value: function bindToggleItem(handler) {
      (0, _helpers.$delegate)(this.referralList, '.toggle', 'click', function (_ref5) {
    ...
    value: function bindEditItemSave(handler) {
      (0, _helpers.$delegate)(this.referralList, 'li .edit', 'blur', function (_ref6) {
      ...
      (0, _helpers.$delegate)(this.referralList, 'li .edit', 'keypress', function (_ref7) {
    ...
    value: function bindEditItemCancel(handler) {
      (0, _helpers.$delegate)(this.referralList, 'li .edit', 'keyup', function (_ref8) {
...
var FontFaceObserver = __webpack_require__(365);
...
//# sourceMappingURL=foolproof-task.js.map